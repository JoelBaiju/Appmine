...
import ai from '../../assets/images/8721928-uhd_4096_2160_25fps-ezgif.com-video-to-gif-converter.gif'
  ...
  return (
    <div className=' '>
        <div className='h-40   w-full flex flex-row px-10 pr-14 justify-between items-center' >
            ...
            <p className='text-lg text-right md:text-2xl poppins font-medium'  >Anything You Can  <br /> Imagine</p>
        </div>
        ...
        <div className='  w-full flex-col flex md:flex-row ' >
            ...
            <div className='md:w-1/2 w-11/12 mx-3 mb-3 md:mr-1.5 flex flex-row relative md:h-144 h-100 ' >

                <img src={AppsBg}  className='w-full rounded-3xl  absolute z-10 h-full ' alt="" />

                <div className='absolute z-20 flex flex-row items-center justify-between w-full md:p-20 p-5 rise'>
                    <div className=' appsheading  flex  flex-col justify-center items-center p-6 w-fit  rounded-3xl'>
                        <div>
                            <h1 className='md:text-5xl text-4xl font-bold text-black text-left'>APP</h1>
                            <h1 className='md:text-4xl text-3xl font-bold text-white text-left'>DEV <br />ELO <br />PME <br />NT</h1>
                        </div>
                    </div>
                    <div className=''>
                        <p className='text-white md:text-2xl text-sm'>Our <br />expert <br />team <br />builds <br />robust <br />applications<br />for both <br />ios and <br />android</p>
                    </div>
                </div>
            ...
            <div className='w-11/12 md:w-1/2 mx-3 md:ml-1.5 mb-3 bg-black md:144 rounded-3xl flex flex-col items-center justify-center relative'>
                <div className='flex flex-row items-center mt-10 m-5 rise'>
                    <h1 className=' text-white text-3xl md:text-4xl font-bold poppins '>GAME</h1>
                ...
                <p className='text-gray-300 font-normal text-sm md:text-lg text-center m-5 z-20 mb-5'>Our expert team builds robust applications <br /> for both ios and android</p>
        ...
        <div className='h-32 w-full flex flex-row px-10  items-center '>
            <h1 className=' md:text-5xl h-14 text-2xl poppins font-semibold'>Artificial Intelli</h1>
            <h1 className=' md:text-5xl h-14 text-2xl poppins font-semibold gradient-text-blue'>gence & ML</h1>
        </div>
