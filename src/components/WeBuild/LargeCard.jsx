...
function LargeCard({WebBg}) {
  ...
  return (
       ...
       <div className='bg-black   mx-3 mb-3 rounded-3xl flex md:flex-row flex-col items-center md:w-auto  w-11/12 ' >
            ...
            <div className='flex flex-col items-center justify-center md:w-1/2 h-56  rise' >
                <div className='flex flex-row items-center '>
                    ...
                    <h1 className='gradient-text text-5xl md:text-7xl poppins font-bold md:h-20 ' >Developing</h1>
                </div>
