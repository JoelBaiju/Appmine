    ...
    useEffect(() => {
        ...
        ScrollTrigger.create({
            ...
            start: "top top", 
                ...
                const aboutimageheight=document.querySelector('#aboutimage').clientHeight
    ...
    <div className='about-main relative' id='about-main'>
        ...
        <div className="container  z-20">
            <div className=" h-screen w-full a flex flex-col justify-center backdrop-blur-md bg-black/80 items-center">
                ...
                {/* <h1 className='text-xl font-light text-white p-10 text-center poppins  '> 
                    At Appmine Studio, we don’t just build software; we create experiences that leave a lasting impact.
            ...
            <div id='about-s2' className=" bg-black  w-full a flex flex-col justify-center  items-">
                <div className='w-full text-center px-5 py-32 '>
                    ...
                    expertise, and dedication into every project, transforming ideas into solutions that inspire, 
                    empower, and elevate. This isn’t just what we do; it’s who we are.   
                        {/* <span className='text-white text-start text-5xl font-semibold poppins'>Innovative: </span> 
                        Innovation is the cornerstone of our company. It has always been the key to our success. 
                        <span className='text-white text-5xl font-semibold poppins'>Quality</span> 
                        Above all else we value quality. A project isn’t complete until it produces optimal results. 
                        <span className='text-white text-5xl font-semibold poppins'>Service</span> 
                        ...
                        <span className='text-white text-5xl font-semibold poppins'>Value</span> 
                        Cost is irrelevant unless we provide the best value to our customers. 
                        <span className='text-white text-5xl font-semibold poppins'>Integrity</span> 
                        We will only operate with the highest standard of integrity and honesty. 
                        <span className='text-white text-5xl font-semibold poppins'>Loyality</span> 
            ...
            <div id='about-s2' className="  w-full a flex flex-col justify-center bg-black/70 items-">
            ...
            <div id='about-s2' className="  w-full a flex flex-col justify-center  bg-black/20 ">
